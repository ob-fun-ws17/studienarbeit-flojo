...
/* package Webserver-0.1.0.0 */
#define VERSION_Webserver "0.1.0.0"
#define MIN_VERSION_Webserver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Webserver-0.1.0.0-2wIQjDRlL5PNyKB5c30ID"

#define CURRENT_PACKAGE_KEY "Webserver-0.1.0.0-2wIQjDRlL5PNyKB5c30ID"
